...
import { useFMPS } from '../../../utils/fixedQuestionnaire';
...
export const FMPSTestItem = () => {


  const { TextArea } = Input;

  const { isLoading, error, data: FMPS } = useFMPS();
  const instruction = FMPS?.instruction;
  const allTests = FMPS?.list;
  // const {instruction, list} = FMPS.data
