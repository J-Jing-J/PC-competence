...
import { useSTAI } from '../../../utils/fixedQuestionnaire';
...
export const STAITestItem = () => {


  const { TextArea } = Input;

  const { isLoading, error, data: STAI } = useSTAI();
  const instruction = STAI?.instruction;
  const allTests = STAI?.list;
  // const {instruction, list} = STAI.data
